			...
			<Box component="section" className="section-2">
				<Box className="section-content">
					...
					<Typography
						...
						sx={{ margin: "0" }}
					>
						<br></br> If you have ever been asked a question during an interview
						that starts with "tell me about a time when you did", then it is
						likely you are being asked a competency based question. Competency
			...
			<Box component="section" className="section-2">
				<Box className="section-content">
					...
					<Typography
						...
						sx={{ margin: "2rem" }}
					>
						Sirius have implemented ES6 and the PERN stack, believing
						them to be most reliable, scalable, fullstack tech solution to real
						world problems. <br></br>
						<br></br> At the frontend we have React and MUI libraries,
						which have helped to boost the productivity, scalability and
						reliability of our application <br></br>
						<br></br> At the backend we are able to dynamically create, store and
						drop user, login and STAR data history utilising Node.js, Express
						and PostreSQL.
						<br></br>
						<br></br>
						Additional tools implemented include Email.js and
						Passport.js, which have been used to send and receive emails and to
						authenticate users. Our project would not have been possible without
						taking advantage of the powerful collaboration tools: GitHub and Slack.
						<br></br>
						<br></br>
